...
export default function Movies() {
  return (
    ...
    >
      ...
      {/* 2-2. 어메이징 스파이더맨 — 스틸 자체에 거미줄 I LOVE YOU가 있으므로 제목만 얹는다 */}
      <div
        id="spider-stage"
      ...
      >
        ...
        <div className="relative z-10 flex min-h-svh flex-col items-center px-6 pb-16 pt-24">
          <p className="chapter-tag" data-reveal>
          ...
          {/* 스틸 속 거미줄 I LOVE YOU가 가운데 보이도록 제목은 하단 오른쪽 정렬 (SHOCK급 크기) */}
          <div className="flex-1" />
          <h3
            className="display self-end text-right text-[15vw] leading-[0.95] text-white drop-shadow-[0_8px_40px_rgba(0,0,0,0.7)] md:pr-6 md:text-[10rem]"
            data-reveal
          >
            The
            <br />
